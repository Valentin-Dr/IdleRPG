...
export const ADD_LOG_MESSAGE_MONSTER_DEAD = 'ADD_LOG_MESSAGE_MONSTER_DEAD';
...
export const addLogMessageMonsterDead = (monster) => ({
  type: ADD_LOG_MESSAGE_MONSTER_DEAD,
  payload: {
    monster,
  },
});
...
export const updateCharacterLevel = (data) => ({
